...
const SERVICE_CATALOG = {
  ...
  SACCOS: {
    key: 'SACCOS',
    name: 'SACCOS',
    swahili: 'SACCOS Digital',
    tagline: 'Vikundi vya akiba na mikopo kwa kidijitali - hisa, mikopo na gawio.',
    description: 'Vikundi vya ushirika vya akiba na mikopo - hisa, mikopo, amana, gawio na mikutano yote kwenye mfumo mmoja.',
    perks: [
      'Hisa, mikopo na amana za ushirika',
      'Gawio na riba za akiba otomatiki',
      'Mikutano, quorum na taarifa za mwisho wa mwaka',
    ],
    cta: 'Jiunge na SACCOS',
    requiresKyc: 1,
    icon: 'landmark',
    emoji: '🏛️',
    color: '#0e7c66',
