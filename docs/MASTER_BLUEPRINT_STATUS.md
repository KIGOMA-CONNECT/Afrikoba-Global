...
- ⬜ Role-based four-eyes (secondary approval flows beyond high-value gates) and
  A/B experimentation engine themselves still next. Model/AI governance register now
  tracked via `ai_model_register` (Phase 8).
