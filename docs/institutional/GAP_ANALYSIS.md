...
| 21 | Test Strategy (AFK-INST-21) | YES — DRAFT | 1.29 | Yes | No | Levels, CI gates, suite list (accurate to CI, 68 suites incl. test-recurrence + test-payment-requests + test-merchant-invoices + test-marketplace + test-family-guardian + test-projection-cache + test-support + test-currency + test-qr + test-insurance + test-cards + test-saccos-foundation + test-saccos-shares + test-saccos-savings + test-saccos-credit + test-saccos-governance + test-saccos-accounting + test-saccos-investments + test-saccos-dividends + test-saccos-funds + test-saccos-exits + test-saccos-reports + test-saccos-installments + test-saccos-arrears + test-saccos-meetings + test-saccos-savings-interest + test-saccos-backing-welfare + test-saccos-loan-mgmt + test-saccos-lending-products + test-saccos-treasury + test-aml-cases + test-saccos-risk-limits + test-remittance-lifecycle + test-merchant-payroll + test-sanctions), flake policy, k6 + uptime workflows | Approve baseline | QA Lead | 2 — MEDIUM ✅ delivered |
