...
| 21 | Test Strategy (AFK-INST-21) | YES — DRAFT | 1.20 | Yes | No | Levels, CI gates, suite list (accurate to CI, 59 suites incl. test-recurrence + test-payment-requests + test-merchant-invoices + test-marketplace + test-family-guardian + test-projection-cache + test-support + test-currency + test-qr + test-insurance + test-cards + test-saccos-foundation + test-saccos-shares + test-saccos-savings + test-saccos-credit + test-saccos-governance + test-saccos-accounting + test-saccos-investments + test-saccos-dividends + test-saccos-funds + test-saccos-exits + test-saccos-reports + test-saccos-installments + test-saccos-arrears + test-saccos-meetings + test-saccos-savings-interest), flake policy, k6 + uptime workflows | Approve baseline | QA Lead | 2 — MEDIUM ✅ delivered |
