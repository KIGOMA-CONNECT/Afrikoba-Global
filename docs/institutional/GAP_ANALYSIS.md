...
| 21 | Test Strategy (AFK-INST-21) | YES — DRAFT | 1.7 | Yes | No | Levels, CI gates, suite list (accurate to CI, 46 suites incl. test-recurrence + test-payment-requests + test-merchant-invoices + test-marketplace + test-family-guardian + test-projection-cache + test-support + test-currency + test-qr + test-insurance + test-cards + test-saccos-foundation + test-saccos-shares), flake policy, k6 + uptime workflows | Approve baseline | QA Lead | 2 — MEDIUM ✅ delivered |
